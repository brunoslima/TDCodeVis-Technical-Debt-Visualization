<?php
require_once("../logica/interacaoBubbleChartAmount.php");
?>
...
<html>
  ...
  <head>    
    <meta charset="utf-8">
    <title>TDCodeVis - Bubble Chart - Amount</title>
  ...
  <body>
    ...
    <section class="conteudo">
      <div class="conteudo-bubblechart">
        ...
        <script src="../js/bubbleChartAmount.js" charset="utf-8"></script>
      </div>
      <div class="filtro-bubblechart">
        
        <h1>Current Version: <?php echo "$vAtual";?></h1>
        <form action="bubbleChartAmount.php" method="POST">
